...
describe('ResourceMetadata Component', () => {
  describe('Rendering with All Fields', () => {
    ...
    it('renders publishers as a list', () => {
      ...
      const publisherList = screen.getByText('Publishers').closest('div')?.querySelector('ul');
    ...
    it('renders creators with Users icon', () => {
      ...
      expect(creatorsHeading.closest('h2')).toHaveClass('flex', 'items-center', 'gap-2');
    });
    ...
    it('renders geographic coverage with MapPin icon', () => {
      ...
      expect(geoHeading.closest('h2')).toHaveClass('flex', 'items-center', 'gap-2');
    });
    ...
    it('renders subjects as styled tags', () => {
      ...
      expect(subjectsHeading.closest('h2')).toHaveClass('flex', 'items-center', 'gap-2');
      
      // Check for styled tags
      const paperMapsTag = screen.getByText('Paper Maps');
      expect(paperMapsTag).toHaveClass('inline-flex', 'items-center', 'px-2.5', 'py-0.5', 'rounded-full', 'text-xs', 'font-medium', 'bg-blue-100', 'text-blue-800');
    });
  ...
  describe('Layout and Styling', () => {
    it('applies correct grid layout classes', () => {
      const { container } = render(<ResourceMetadata item={realFixtureWithAllFields} />);
    ...
    it('applies correct spacing classes to sections', () => {
      ...
      const leftColumn = screen.getByText('Source').closest('div')?.parentElement;
      expect(leftColumn).toHaveClass('space-y-6');
      
      const rightColumn = screen.getByText('Geographic Coverage').closest('div')?.parentElement;
    ...
    it('applies correct heading styles', () => {
      ...
      expect(sourceHeading).toHaveClass('text-sm', 'font-medium', 'text-gray-500');
    });
  ...
  describe('Edge Cases', () => {
    ...
    it('handles very long text content', () => {
      ...
      expect(screen.getByText(/Creator with Very Long Name/)).toBeInTheDocument();
    });
